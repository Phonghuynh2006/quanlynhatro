...
//import polycafe.cafe.entity.Category;
//import polycafe.cafe.entity.User;
/**
 *
 * @author PHONG
 */
...
//    public static List<Category> getEntityList(Class<Category> aClass, String findAllSql, String categoryId) {
//        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
//    }
    // thêm vô
    public static <T> List<T> getEntityList(Class<T> clazz, String sql, Object... values) {
    return getBeanList(clazz, sql, values);
    }
